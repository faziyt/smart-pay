...
export class Backend implements backendInterface {
    ...
    async sendMoney(arg0: Principal, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async topUp(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async userExists(arg0: Principal): Promise<boolean> {
        if (this.processError) {
            try {
...
function from_candid_record_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        transactionType: from_candid_TransactionType_n11(_uploadFile, _downloadFile, value.transactionType),
        from: value.from,
...
function from_candid_variant_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "completed" in value ? TransactionStatus.completed : "failed" in value ? TransactionStatus.failed : value;
}
function from_candid_variant_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "topup" in value ? TransactionType.topup : "send" in value ? TransactionType.send : value;
}
